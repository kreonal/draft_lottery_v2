const teams = [
    { name: 'Nick', oddsFirst: 25.00, oddsTop4: 40.67, seasonFinish: 10 },
    { name: 'Shaun', oddsFirst: 20.00, oddsTop4: 32.53, seasonFinish: 9 },
    { name: 'Anthony', oddsFirst: 15.00, oddsTop4: 24.40, seasonFinish: 15 },
    { name: 'Matt', oddsFirst: 12.00, oddsTop4: 19.52, seasonFinish: 11 },
    { name: 'Aaron', oddsFirst: 6.00, oddsTop4: 9.76, seasonFinish: 16 },
    { name: 'Calvin', oddsFirst: 5.00, oddsTop4: 8.13, seasonFinish: 13 },
    { name: 'Henry', oddsFirst: 4.00, oddsTop4: 6.51, seasonFinish: 1 },
    { name: 'Karan', oddsFirst: 4.00, oddsTop4: 6.51, seasonFinish: 14 },
    { name: 'Rohan', oddsFirst: 3.00, oddsTop4: 4.88, seasonFinish: 12 },
    { name: 'John', oddsFirst: 3.00, oddsTop4: 4.88, seasonFinish: 5 },
    { name: 'Kendall', oddsFirst: 2.00, oddsTop4: 3.25, seasonFinish: 6 },
    { name: 'Zack', oddsFirst: 1.00, oddsTop4: 1.63, seasonFinish: 2 },
    { name: 'Joey', oddsFirst: 0.00, oddsTop4: 0.00, seasonFinish: 7 },
    { name: 'Minh', oddsFirst: 0.00, oddsTop4: 0.00, seasonFinish: 8 },
    { name: 'Alfred', oddsFirst: 0.00, oddsTop4: 0.00, seasonFinish: 4 },
    { name: 'Prashant', oddsFirst: 0.00, oddsTop4: 0.00, seasonFinish: 3 }
];

// Swap Minh and Joey for their final picks
const lockedTeams = ['Minh', 'Joey', 'Alfred', 'Prashant'];
